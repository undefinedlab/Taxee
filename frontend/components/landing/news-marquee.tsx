const newsItems = [
  {
    badge: "Live",
    text: "Open alpha is live — register an agent, connect a wallet, and try tax-aware flows on Base.",
  },
  {
    badge: "Open alpha",
    text: "Early access: features ship weekly. Expect rough edges — we want your feedback.",
  },
  {
    badge: "Now",
    text: "Manual approve or delegated mode — same agent, your choice while we harden execution.",
  },
  {
    badge: "Base",
    text: "Start on Base Sepolia or mainnet-aligned paths; more chains as alpha expands.",
  },
];
  ...
  return (
    <span className="mx-5 inline-flex items-center gap-2.5 sm:mx-7">
      <span className="inline-flex shrink-0 items-center gap-1.5 rounded-full border border-black/10 bg-black/[0.04] px-2.5 py-0.5 font-landing text-[10px] font-semibold uppercase tracking-wide text-black/50 dark:border-white/10 dark:bg-white/[0.06] dark:text-white/50">
        <span className="h-1.5 w-1.5 rounded-full bg-landing-active/90" />
        {badge}
      </span>
